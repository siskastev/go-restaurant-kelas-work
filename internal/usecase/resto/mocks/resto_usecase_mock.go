...
func (m *MockRestoUsecase) CreateOrder(ctx context.Context, request model.MenuOrderRequest) (model.Order, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRestoUsecaseMockRecorder) CreateOrder(ctx, request interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateOrder", reflect.TypeOf((*MockRestoUsecase)(nil).CreateOrder), ctx, request)
}
